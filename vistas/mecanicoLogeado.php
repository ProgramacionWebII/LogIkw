...
<nav class="navbar navbar-inverse">
  <div class="container-fluid col-sm-12">
	...
	<ul class="nav navbar-nav navbar-right">
		<li><a href=""><span class="glyphicon glyphicon-user" ></span> Bienvenido <?php echo $mecanico['nombre'] ?></a></li>
		<li><a href=" <?php echo 'admin/abmMantenimiento.php'; ?>"><span class="glyphicon glyphicon-list-alt" ></span> Mantenimiento de Vehiculos</a></li>
	</ul>
</nav>
