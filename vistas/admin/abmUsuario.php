...
<nav class="navbar navbar-inverse">
	...
	<ul class="nav navbar-nav navbar-right">
		<li class=""><a href=" <?php echo 'abmCliente.php'; ?>"><span class="glyphicon glyphicon-list-alt" ></span> Cliente</a></li>
	</ul>
	<ul class="nav navbar-nav navbar-right">
		<li class="active"><a href=" <?php echo 'abmUsuario.php'; ?>"><span class="glyphicon glyphicon-list-alt" ></span> Usuario</a></li>
	</ul>
	<ul class="nav navbar-nav navbar-right">
...
<div class="col-sm-10 col-sm-offset-1">
  ...
  <table class="table table-condensed">
	...
	<!-- Modal de agregar-->
    <form action="../../modelo/ejecutarAbmUsuario.php" method="POST">
	<div class="modal fade" id="agregarUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content col-sm-12">
	      <div class="modal-header">
	        <h2 class="modal-title" id="exampleModalLabel">Alta Nuevo Usuario</h2>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	        </button>
	      </div>
